...
{
    public abstract class AISPharmacyWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AISPharmacyWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AISPharmacyWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AISPharmacyDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AISPharmacyDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AISPharmacyDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AISPharmacyDbContext, Task<T>> func)
        {
            T result;
